...
- [X] T004 Postgres foundation: pool, health check, migrations, roles | traces: FR-003, FR-005, AC-003-01, AC-003-03, AC-005-01, AC-005-02, AC-005-03
...
- [X] T005 State layer: Postgres-backed project and refresh stores | traces: FR-004, AC-004-01, AC-004-02, AC-004-03, AC-004-04
...
- [X] T006 DB audit: Postgres logger and append-only grants | traces: FR-005, AC-005-01, AC-005-02, AC-005-03, AC-005-04
...
- [X] T007 Queue adapter: replace custom SQLite queue with pg-boss | traces: FR-006, AC-006-01, AC-006-02, AC-006-04
...
- [X] T008 Worker wiring: pg-boss handlers and graceful shutdown | traces: FR-006, AC-006-01, AC-006-02, AC-006-03
...
- [X] T009 Import/export: JSON config-as-code round trip | traces: FR-007, AC-007-01, AC-007-02, AC-007-03, AC-007-04
...
- [X] T010 Vector regression: preserve existing vector storage behavior | traces: FR-008, AC-008-01, AC-008-02, AC-008-03
...
- [X] T011 Runtime wiring: API, MCP, CLI, and worker receive Postgres-backed dependencies | traces: FR-002, FR-003, FR-004, FR-006, FR-010
...
- [X] T012 Local build guidance: DB env, E2E skip mode, and developer commands | traces: FR-001, FR-009, FR-010, AC-009-01, AC-009-02, AC-010-03
...
- [X] T013 Cleanup legacy runtime state paths and docs | traces: FR-002, FR-003, FR-006, FR-008, FR-010
...
- [X] T014 Test execution: unit, integration, configured DB E2E or explicit skips | traces: FR-001, FR-002, FR-003, FR-004, FR-005, FR-006, FR-007, FR-008, FR-009, FR-010
...
- [X] T015 Parity verification: behavior preserved except accepted substrate changes | traces: FR-004, FR-006, FR-007, FR-008
...
- [X] T016 Code review: constitutional and security review | traces: FR-001, FR-002, FR-003, FR-004, FR-005, FR-006, FR-007, FR-008, FR-009, FR-010
...
- [X] T017 Dual file check: active tasks and REQ artifact consistency | traces: FR-001, FR-002, FR-003, FR-004, FR-005, FR-006, FR-007, FR-008, FR-009, FR-010
