...
// ---------------------------------------------------------------------------
// composeDirName(itemType, source, sourceId, descriptionSlug, sequenceNumber)
// ---------------------------------------------------------------------------
 ...
 */
function composeDirName(itemType, source, sourceId, descriptionSlug, sequenceNumber) {
    const _b = _getBacklogBridge(); if (_b?.composeDirName) return _b.composeDirName(itemType, source, sourceId, descriptionSlug, sequenceNumber);
